...
def uniformCostSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        for state, direction, cost in problem.getSuccessors(curState):
            fringe.push((state, curMoves+[direction], curCost),problem.getCostOfActions(curMoves+[direction]))
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not fringe.isEmpty():
         ...
         for state, direction, cost in problem.getSuccessors(curState):
            cost = problem.getCostOfActions(curMoves+[direction]) + heuristic(curState,problem)
            fringe.push((state, curMoves+[direction]), cost)
